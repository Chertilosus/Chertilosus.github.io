...
(self.webpackChunkgrowth_game_ui = self.webpackChunkgrowth_game_ui || []).push([[9910], {
    J5u7: (t, e, i) => {
        "use strict";
        i.d(e, {
            x: () => o
    ...
    NXaq: (t, e, i) => {
        ...
        var E = i("Lp65")
          ...
          , U = function(t, e) {
            return [Math.floor(z(t - 100) + 50), Math.floor(z(e - 300 - 100) + 300 + 50)]
        };
        const Y = function(t) {
            (0,
            G.A)(i, t);
            ...
            function i() {
                ...
                (0,
                I.A)((0,
                R.A)(t), "swipeSpeedLate", H),
                (0,
                I.A)((0,
                R.A)(t), "stickOffsetX", 0),
                (0,
                I.A)((0,
                R.A)(t), "stickOffsetY", 0),
                (0,
                I.A)((0,
                R.A)(t), "isPlaying", !1),
                (0,
                ...
                (0,
                I.A)((0,
                R.A)(t), "swipeMovement", null),
                (0,
                I.A)((0,
                R.A)(t), "playerMovement", []),
                (0,
                I.A)((0,
                R.A)(t), "selectedItem", null),
                (0,
                I.A)((0,
                R.A)(t), "colliders", []),
                (0,
                ...
                (0,
                I.A)((0,
                R.A)(t), "firingPosition", null),
                (0,
                I.A)((0,
                R.A)(t), "currentItem", null),
                (0,
                I.A)((0,
                R.A)(t), "twinklingStar", null),
                (0,
                I.A)((0,
                R.A)(t), "bgm", null),
                (0,
                ...
                (0,
                I.A)((0,
                R.A)(t), "sfxGameOver", null),
                (0,
                I.A)((0,
                R.A)(t), "sfxHitItem", null),
                (0,
                I.A)((0,
                R.A)(t), "sfxHitTrap", null),
                (0,
                I.A)((0,
                R.A)(t), "sfxTimeRunningOut", null),
                (0,
                I.A)((0,
                R.A)(t), "isLate", !1),
                t
            ...
            N.A)(i, [{
                ...
                value: function() {
                    ...
                    this.swipeSpeedLate = o.TEST_HOOKFINAL_SPEED || o.finalHookSwipeSpeed,
                    ...
                    o.itemSettingList.forEach((function(e) {
                        ...
                        e.rewardValueList.forEach((function(e) {
                            ...
                            c.setDepth(3);
                            for (var d = t.physics.add.existing(c), u = 30; u > 0 && t.items.children.entries.some((function(e) {
                ...
                value: function() {
                    ...
                    if (this.isPlaying && this.isAiming && !this.isFiring && !this.isPulling) {
                        ...
                        var e = this.stick.angle
                          , i = this.hook.x - Math.sin(x.Phaser.Math.DegToRad(e)) * this.hook.width / 2
                          , s = this.hook.y + Math.cos(x.Phaser.Math.DegToRad(e)) * this.hook.height / 2;
                        this.firingPosition = {
                            x: i,
                            y: s
                        },
                        ...
                        var n = {
                            x: this.hookBody.x - 2e3 * Math.sin(x.Phaser.Math.DegToRad(e)),
                            y: this.hookBody.y + 2e3 * Math.cos(x.Phaser.Math.DegToRad(e))
                        };
                ...
                value: function(t) {
                    ...
                    this.currentItem = {
                        ...
                        level: t && "BONUS" === t.type ? t.size + t.pts : Math.floor(z(200))
                    },
                    this.tweens.add({
                        targets: [this.stick],
                        scale: 1,
                ...
                value: function(t, e) {
                    ...
                    if (this.isAiming) {
                        ...
                        var c = this.stick.x - n * this.stick.geom.y2 * this.stick.scaleY
                          , d = this.stick.y + a * this.stick.geom.y2 * this.stick.scaleY;
                        if (this.hook.setPosition(c, d),
                        this.selectedItem) {
        ...
        var W = i("0CAK")
          ...
          , Q = function(t) {
            ...
            d.useState)(!0)
              ...
              , r = a[1]
              , h = (0,
            x.useEventEmitter)("TOGGLE_SOUND")
              , l = (0,
            D._)()
              , u = l.isSoundOn
              , f = l.toggleSoundOn
            ...
            (0,
            x.useEventListener)("LOAD_PROGRESS", P),
            (0,
            x.useEventListener)("LOAD_COMPLETE", O),
            (0,
            x.useEventListener)("GAME_START", i),
            (0,
            x.useEventListener)("UPDATE_TIMELEFT", E),
            (0,
            x.useEventListener)("UPDATE_SCORE", b),
            (0,
            x.useEventListener)("GAME_END", s);
            var C = (0,
            d.useCallback)((function() {
                p(),
                h(!1)
        ...
        const q = function(t) {
            ...
            d.useEffect)((function() {
                if (!M.db) {
                    var t = new URLSearchParams(window.location.search)
                      , e = {};
                    ["hook", "hookFinal", "reward", "bonus"].forEach((function(i) {
                        var s = t.get("".concat(i, "Speed"));
                        if (s) {
                            var n = parseInt(s);
                            Number.isInteger(n) && n > 0 && (T({
                                message: "Set ".concat(i, " speed to ").concat(n, " px/s")
                            }),
            ...
            d.useMemo)((function() {
              ...
              , U = (0,
            d.useMemo)((function() {
                var t = (null === S || void 0 === S ? void 0 : S.cryptoMinerConfig) || {}
                  , e = t.gameDuration
                  , i = (0,
                o.A)(t, ["gameDuration"]);
                return {
            ...
            if (E)
                ...
                if (T) {
                    var M = l(S)
                      ...
                      , D = !M && !b && p(S);
                    L = S,
                    M || b || D ? l(w) ? L = w : c(w) ? L = o(w) : b ? (T = !1,
                    L = n(S, !0)) : D ? (T = !1,
                    L = a(S, !0)) : L = [] : f(S) || h(S) ? (L = w,
                    h(w) ? L = v(w) : m(w) && !u(w) || (L = r(S))) : T = !1
                }
                T && (k.set(S, L),
                x(L, S, y, A, k),
                k.delete(S)),
